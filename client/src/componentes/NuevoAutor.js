        ...
        <div>
            ...
            <form onSubmit={guardarAutor}>
                <div className="form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" value={nombre} onChange={e => setNombre(e.target.value)} className="form-control"></input>
                ...
                <div className="form-group">
                    ...
                    <label className="form-checked-label" htmlFor="libros">
                            Autor de Libros
                    </label>
                </div>
                <div className="form-group">
                    ...
                    <label className="form-checked-label" htmlFor="cuentos">
                            Autor de Cuentos
                    </label>
                </div>
                <div className="form-group">
                    ...
                    <label className="form-checked-label" htmlFor="articulos">
                            Autor de Articulos
                    </label>
                </div>
